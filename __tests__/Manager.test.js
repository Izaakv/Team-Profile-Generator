...
describe("Manager", () => {
  ...
  describe("Manager object instantiation", () => {
    it("Creates an object with name, id, email, and officeNumber properties", () => {
      const manager = new Manager("izaak villa", 1, "izaakvilla@gmail.com", 50);

      expect(manager).toBeInstanceOf(Manager);
      expect(manager.name).toEqual("izaak villa");
      expect(manager.id).toEqual(1);
      expect(manager.email).toEqual("izaakvilla@gmail.com");
  ...
  describe("getName", () => {
    it("Should return the object's name property", () => {
      ...
      expect(manager.getName()).toEqual("izaak villa");
    });
  });
  ...
  describe("getEmail", () => {
    it("Should return the object's email property", () => {
      ...
      expect(manager.getEmail()).toEqual("izaakvilla@gmail.com");
    });
  });
